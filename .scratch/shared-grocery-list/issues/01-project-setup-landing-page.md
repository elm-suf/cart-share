...
**What to build:** A clean, mobile-friendly project structure containing an Angular + TypeScript frontend, an Express backend server, and a unified styling system (Vanilla CSS). The root path `/` displays a simple landing page with a single prominent call-to-action button: "Create a Grocery List". At this stage, the button has no backend link and only serves as a visual placeholder.
